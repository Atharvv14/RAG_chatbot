...
from langchain.schema import Document  # <-- import Document for wrapping text chunks
...
Helpful Answer:"""
    ...
    def _load_knowledge_base(self, knowledge_base_path):
        ...
        # Wrap text splits into Document objects
        documents = [Document(page_content=chunk) for chunk in md_header_splits]
...
if __name__ == "__main__":
    # Change these two paths to your actual model and knowledge base path
    model_name = "gpt-4o-mini"  # or "gpt-3.5-turbo" if you prefer
    knowledge_base_file = "knowledge_base.md"  # replace with your markdown file

    bot = Chatbot(model_name, knowledge_base_file)
    print("Chatbot is ready. Ask something!")
